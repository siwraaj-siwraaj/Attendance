...
function PeopleIllustration() {
  return (
    <div className="relative mx-auto mb-5 h-[118px] w-[250px]" aria-hidden="true">
      <div
        className="absolute inset-x-5 bottom-0 h-[108px] rounded-[55%_55%_18%_18%]"
        style={{ background: "rgba(69, 88, 124, 0.48)" }}
      />

      {/* Left person */}
      <svg
        className="absolute left-0 bottom-0 h-[108px] w-[92px]"
        viewBox="0 0 92 108"
        fill="none"
      >
        <circle cx="46" cy="30" r="22" fill="#f7b08f" />
        <path
          d="M23 29c1-17 11-25 24-25 13 0 23 9 24 25-7-7-13-10-23-10-10 0-17 4-25 10Z"
          fill="#182238"
        />
      ...
      {/* Center person */}
      <svg
        className="absolute left-1/2 bottom-0 h-[118px] w-[108px] -translate-x-1/2"
        viewBox="0 0 108 118"
        fill="none"
      >
        <circle cx="54" cy="31" r="23" fill="#f8b28f" />
        <path
          d="M30 30c0-19 10-28 25-28 14 0 24 9 24 28-7-9-15-13-25-13-10 0-17 4-24 13Z"
          fill="#111a2d"
        />
      ...
      {/* Right person / worker */}
      <svg
        className="absolute right-0 bottom-0 h-[108px] w-[92px]"
        viewBox="0 0 92 108"
        fill="none"
      >
...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="mb-3 flex h-16 w-16 items-center justify-center rounded-[20px] shadow-2xl"
          style={{
      ...
      >
        <form className="login-card p-6" onSubmit={handleSubmit} data-ocid="login.form">
          <div className="mb-5 text-center">
            <h2 className="mb-1 text-xl font-bold text-white" style={{ fontFamily: "Figtree, sans-serif" }}>
              Welcome Back
            </h2>
            <p className="text-sm" style={{ color: "#8892a4" }}>
              Sign in to continue to Rossie
            </p>
          </div>

          {error && (
            <div className="login-error mb-4" role="alert" data-ocid="login.error">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <UserRound
                size={19}
                strokeWidth={1.8}
                className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-[#9aa6ba]"
                aria-hidden="true"
              />
              <input
                id="login-username"
                ...
                className={`login-input pl-11 ${error ? "login-input-error" : ""}`}
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`login-input pl-11 pr-10 ${error ? "login-input-error" : ""}`}
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-[#8892a4] transition-colors hover:text-white"
          ...
          <label className="mb-5 flex cursor-pointer items-center gap-2.5 select-none">
            ...
            />
            <span className="text-sm" style={{ color: "#aab3c2" }}>Remember me</span>
          </label>

          <button
            type="submit"
            className="login-submit flex w-full items-center justify-center gap-2"
            disabled={submitting}
          ...
          <button
            ...
            className="mx-auto mt-5 flex items-center gap-3 rounded-xl px-4 py-2 text-left transition-colors hover:bg-white/5"
            disabled={biometricBusy || submitting}
          >
            <span
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-orange-500/80 text-orange-400"
              style={{ boxShadow: "0 0 18px rgba(249,115,22,0.16)" }}
            >
              {biometricBusy ? <Loader2 size={22} className="animate-spin" /> : <Fingerprint size={25} strokeWidth={1.7} />}
            </span>
            <span>
              <span className="block text-sm font-semibold text-white">
                {biometricBusy ? "Verifying…" : "Use fingerprint"}
              </span>
              <span className="block text-xs" style={{ color: "#8892a4" }}>
                Quick &amp; secure access
              </span>
            </span>
          </button>
