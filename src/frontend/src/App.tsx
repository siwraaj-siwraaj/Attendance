  ...
  return (
    <div className="px-5 py-4 space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-blue-50/60 dark:bg-slate-800/40 border border-blue-100 dark:border-slate-800 rounded-2xl p-4"><span className="text-xs text-slate-400">Total</span><p className="text-2xl font-extrabold text-blue-600">24</p></div>
        <div className="bg-emerald-50/60 dark:bg-slate-800/40 border border-emerald-100 dark:border-slate-800 rounded-2xl p-4"><span className="text-xs text-slate-400">Present</span><p className="text-2xl font-extrabold text-emerald-600">20</p></div>
        <div className="bg-rose-50/60 dark:bg-slate-800/40 border border-rose-100 dark:border-slate-800 rounded-2xl p-4"><span className="text-xs text-slate-400">Absent</span><p className="text-2xl font-extrabold text-rose-600">4</p></div>
        <div className="bg-purple-50/60 dark:bg-slate-800/40 border border-purple-100 dark:border-slate-800 rounded-2xl p-4"><span className="text-xs text-slate-400">On Leave</span><p className="text-2xl font-extrabold text-purple-600">0</p></div>
      </div>
      <div><h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">Quick Actions</h4><div className="grid grid-cols-2 gap-3">
        <button onClick={() => setCurrentScreen("attendance")} className="bg-blue-50/40 dark:bg-slate-800/50 border border-blue-100 dark:border-slate-800 rounded-2xl p-4 flex flex-col items-center text-center"><div className="w-10 h-10 rounded-xl bg-blue-100 dark:bg-blue-900/50 text-blue-600 flex items-center justify-center mb-2"><Calendar size={20} /></div><span className="text-xs font-bold">Mark Attendance</span></button>
        <button onClick={() => setCurrentScreen("contracts")} className="bg-emerald-50/40 dark:bg-slate-800/50 border border-emerald-100 dark:border-slate-800 rounded-2xl p-4 flex flex-col items-center text-center"><div className="w-10 h-10 rounded-xl bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 flex items-center justify-center mb-2"><FileText size={20} /></div><span className="text-xs font-bold">View Contracts</span></button>
        <button onClick={() => setCurrentScreen("payments")} className="bg-purple-50/40 dark:bg-slate-800/50 border border-purple-100 dark:border-slate-800 rounded-2xl p-4 flex flex-col items-center text-center"><div className="w-10 h-10 rounded-xl bg-purple-100 dark:bg-purple-900/50 text-purple-600 flex items-center justify-center mb-2"><DollarSign size={20} /></div><span className="text-xs font-bold">Payments</span></button>
        <button onClick={() => setCurrentScreen("advances")} className="bg-orange-50/40 dark:bg-slate-800/50 border border-orange-100 dark:border-slate-800 rounded-2xl p-4 flex flex-col items-center text-center"><div className="w-10 h-10 rounded-xl bg-orange-100 dark:bg-orange-900/50 text-orange-600 flex items-center justify-center mb-2"><DollarSign size={20} /></div><span className="text-xs font-bold">Advances</span></button>
      </div></div>
    </div>
  );
}
